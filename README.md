...
6. Python falls woefully short when it comes to modelling Generalized Additive Models (GAMs). My personal recommendation will be to use R to model GAMs. This is applicable for both Section 7.8.3 in R Labs and Question 10 in Applied Exercises in Chapter 7.
